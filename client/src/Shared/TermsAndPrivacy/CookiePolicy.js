...
import { SUPPORT_EMAIL, APP_WEBSITE, APP_NAME } from '../../Utils/constants';
...
class CookiePolicy extends React.Component {
  ...
  render() {
    return (
      <div>
        <h1>Cookie Policy for {APP_NAME}</h1>

        <p>This is the Cookie Policy for {APP_NAME}, accessible from {APP_WEBSITE}</p>
